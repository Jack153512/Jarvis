...
const ConfirmationPopup = ({ request, onConfirm, onDeny }) => {
    return (
        ...
        <motion.div
            ...
            className="relative w-full max-w-lg p-8 bg-black/90 border border-cyan-500/30 rounded-3xl shadow-[0_0_50px_rgba(34,211,238,0.15)] backdrop-blur-2xl"
        >
                <div className="noise-overlay absolute inset-0 opacity-10 pointer-events-none mix-blend-overlay rounded-3xl"></div>
